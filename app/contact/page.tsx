...
export const metadata = {
  title: "문의하기 | Seoul App Studio",
  description: "서울앱스튜디오에 문의하고 무료 상담을 받아보세요.",
};
    ...
    <>
      ...
      <section className="bg-gradient-to-r from-blue-50 to-indigo-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            서울앱스튜디오에 문의하시고 프로젝트에 대한 무료 상담을 받아보세요.
          </motion.p>
        </div>
      </section>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-gray-600">평일 9:00 - 18:00</p>
                  </div>
                </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">오시는 길</h2>
